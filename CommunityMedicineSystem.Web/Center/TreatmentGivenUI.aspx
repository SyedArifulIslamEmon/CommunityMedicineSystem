            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <asp:Button ID="logoutButton" runat="server" CssClass="btn btn-default" Text="Logout" OnClick="logoutButton_Click" /></li>
                    </ul>
                </div>
        ...
        <div id="about-section">
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <%--<asp:RadioButtonList ng-model="doseType" ID="doseTypeRadioButton" runat="server" CssClass="radio-inline">
                            <asp:ListItem>Before Meal</asp:ListItem>
                            <asp:ListItem>After Meal</asp:ListItem>
                        </asp:RadioButtonList>--%>
                        <%--<asp:RadioButton ng-model="doseType" ID="beforeMealRadioButton" runat="server" Checked="True" GroupName="doseType" Text="Before Meal" />
                        <asp:RadioButton ng-model="doseType" ID="afterMealRadioButton" runat="server" GroupName="doseType" Text="After Meal" />--%>
